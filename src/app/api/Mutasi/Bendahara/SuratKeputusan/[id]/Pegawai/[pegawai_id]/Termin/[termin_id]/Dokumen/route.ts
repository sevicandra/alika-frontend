...
export async function GET(
  ...
  try {
    const res = await fetch(
      `${apiBaseUrl}/api/v2/Bendahara/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Termin/${termin_id}/Dokumen`,
      {
        method: "GET",
        headers: {
...
export async function PATCH(
  ...
  try {
    const res = await fetch(
      `${apiBaseUrl}/api/v2/Bendahara/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Termin/${termin_id}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
