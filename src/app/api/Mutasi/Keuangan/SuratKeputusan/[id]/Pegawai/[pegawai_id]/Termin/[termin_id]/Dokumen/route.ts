...
export async function GET(
  req: Request,
  { params }: { params: Promise<{ id: string; pegawai_id: string; termin_id: string }> }
) {
  ...
  try {
    const suratKeputusan = await fetch(
      `${apiBaseUrl}/api/v2/Keuangan/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Termin/${termin_id}/Dokumen`,
      {
        method: "GET",
        headers: {
