...
export async function GET(
  ...
  try {
    const res = await fetch(
      `${apiBaseUrl}/api/v2/SDM/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Keluarga?${searchParamsString.toString()}`,
      {
        method: "GET",
        headers: {
...
export async function POST(
  ...
  try {
    const res = await fetch(
      `${apiBaseUrl}/api/v2/SDM/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Keluarga`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
