...
export default function Page({
  ...
  async function submitForm() {
    try {
      ...
      const res = await fetch(
        `/api/Mutasi/SDM/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Keluarga/Process`,
        {
          headers: {
  ...
  return (
    <Confirmation
      title="Process Data Keluarga"
      message="Data Keluarga ini akan diproses"
