        ...
        <div className="flex min-w-max justify-end gap-1">
          {pegawai?.status === "DRAFT" &&
            ...
            suratKeputusan?.status !== "SELESAI" && (
              <>
                <Link
                  href={`/mutasi/sdm/addendum-pembayaran/${id}/pegawai/${pegawai_id}/biaya/reset`}
                  className="btn btn-xs btn-success"
                >
                  Reset
                </Link>
                <Link
                  href={`/mutasi/sdm/addendum-pembayaran/${id}/pegawai/${pegawai_id}/biaya/new`}
                  className="btn btn-xs btn-success"
                >
                  Tambah Biaya
                </Link>
          ...
          {pegawai?.status === "DRAFT" &&
            ...
            suratKeputusan?.status !== "SELESAI" && (
              <>
                <Link
                  href={`/mutasi/sdm/addendum-pembayaran/${id}/pegawai/${pegawai_id}/biaya/process`}
                  className="btn btn-xs btn-success"
                >
                  Process
                </Link>
