    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(
          `/api/Mutasi/Admin/Referensi/Pesawat?${searchParams}`,
          {
            method: "GET",
          },
        );
        ...
        addNotification({
          title: "Fetch Referensi Rute Pesawat",
                ...
                <td className="p-4">
                  <div className="flex gap-1">
                    <div className="tooltip" data-tip="edit">
                      <Link
                        href={`/mutasi/admin/referensi/pesawat/${row.id}/edit`}
                      >
                    ...
                    <div className="tooltip" data-tip="hapus">
                      <Link
                        href={`/mutasi/admin/referensi/pesawat/${row.id}/hapus`}
                      >
