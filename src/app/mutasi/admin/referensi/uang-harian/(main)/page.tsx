    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(
          `/api/Mutasi/Admin/Referensi/UangHarian?${searchParams}`,
          {
            method: "GET",
          },
        );
                ...
                <td className="p-4">
                  <div className="flex gap-1">
                    <div className="tooltip" data-tip="edit">
                      <Link
                        href={`/mutasi/admin/referensi/uang-harian/${row.id}/edit`}
                      >
                    ...
                    <div className="tooltip" data-tip="hapus">
                      <Link
                        href={`/mutasi/admin/referensi/uang-harian/${row.id}/hapus`}
                      >
