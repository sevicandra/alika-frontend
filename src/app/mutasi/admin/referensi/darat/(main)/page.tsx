  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setLoading(true);
        const res = await fetch(`/api/Mutasi/Admin/Referensi/Darat?${searchParams}`, {
          method: "GET",
        });
        if (!res.ok) {
                ...
                <td className="p-4">
                  <div className="flex gap-1">
                    <div className="tooltip" data-tip="edit">
                      <Link href={`/mutasi/admin/referensi/darat/${row.id}/edit`}>
                    ...
                    <div className="tooltip" data-tip="hapus">
                      <Link href={`/mutasi/admin/referensi/darat/${row.id}/hapus`}>
