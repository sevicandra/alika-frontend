  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setLoading(true);
        const res = await fetch(`/api/Mutasi/Admin/Referensi/HubunganKeluarga?${searchParams}`, {
          method: "GET",
        });
        if (!res.ok) {
        ...
        addNotification({
          title: "Fetch Referensi Hubungan Keluarga",
                ...
                <td className="p-4">
                  <div className="flex gap-1">
                    <div className="tooltip" data-tip="edit">
                      <Link href={`/mutasi/admin/referensi/hubungan-keluarga/${row.id}/edit`}>
                    ...
                    <div className="tooltip" data-tip="hapus">
                      <Link href={`/mutasi/admin/referensi/hubungan-keluarga/${row.id}/hapus`}>
