export default function Home() {
  return (
    <div className="relative h-full grid grid-rows-[auto_auto_1fr] overflow-hidden p-4 gap-2">
      <div className="sticky top-0 z-10 overflow-x-auto overflow-y-hidden shadow-base-content/10 p-2">
        <h2 className="text-2xl uppercase font-bold">Dashboard</h2>
      </div>
      ...
      <div className="flex flex-col gap-2 bg-base-200 p-2 rounded-box">
        <div className="bg-base-100 min-h-64 rounded-box grid grid-rows-[auto_1fr] shadow shadow-base-content/10 gap-2 overflow-hidden p-2 col-span-1 md:col-span-4 sm:col-span-2">
