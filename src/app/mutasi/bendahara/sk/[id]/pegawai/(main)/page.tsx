...
import { useSkDetail } from "@/context/mutasi/bendahara";
    ...
    const fetchPegawai = async () => {
      ...
      try {
        const res = await fetch(
          `/api/Mutasi/Bendahara/SuratKeputusan/${id}/Pegawai?${searchParams}`,
          {
            method: "GET",
          },
        );
            ...
            <div className="max-w-full px-4">
              ...
              >
                <div className="tooltip" data-tip="keluarga">
                  <Link
                    href={`/mutasi/bendahara/sk/${id}/pegawai/${row.id}/keluarga`}
                  >
                ...
                <div className="tooltip" data-tip="termin">
                  <Link
                    href={`/mutasi/bendahara/sk/${id}/pegawai/${row.id}/termin`}
                  >
                    <div className="rounded-box bg-info/80 p-1 text-info-content">
                      <Icon
                        className="hover:scale-110"
                ...
                <div className="tooltip" data-tip="history">
                  <Link
                    href={`/mutasi/bendahara/sk/${id}/pegawai/${row.id}/riwayat`}
                  >
                    <div className="rounded-box bg-info/80 p-1 text-info-content">
                      <Icon
                        className="hover:scale-110"
