    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(
          `/api/Mutasi/PPK/SuratKeputusan/${id}/Pegawai/${pegawai_id}/History`,
          {
            method: "GET",
          },
        );
                    ...
                    <div className="max-w-full px-4">
                      ...
                      >
                        <div className="tooltip" data-tip="payload">
                          <Link
                            href={`/mutasi/ppk/sk/${id}/pegawai/${pegawai_id}/riwayat/${item.id}/payload`}
                          >
                  ...
                  {item.action_type !== "GENERAL_ACTION" && (
                    <div className="max-w-full px-4">
                      ...
                      >
                        <div className="tooltip" data-tip="payload">
                          <Link
                            href={`/mutasi/ppk/arsip/${id}/pegawai/${pegawai_id}/riwayat/${item.id}/payload`}
                          >
                            <div className="rounded-box bg-info/80 p-1 text-info-content">
                              <Icon
                                className="hover:scale-110"
