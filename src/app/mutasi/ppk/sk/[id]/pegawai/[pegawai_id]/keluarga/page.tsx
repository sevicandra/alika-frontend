...
import { usePegawaiDetail } from "@/context/mutasi/ppk";
    ...
    const fetchPegawai = async () => {
      ...
      try {
        const res = await fetch(
          `/api/Mutasi/PPK/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Keluarga?${searchParams}`,
          {
            method: "GET",
          },
        );
                ...
                <tr key={index}>
                  ...
                  <td className="px-4 py-2">
                    <div className="tooltip" data-tip="termin">
                      {row.file && (
                        <Link
                          href={`/mutasi/ppk/sk/${id}/pegawai/${pegawai_id}/keluarga/${row.id}/file`}
                        >
