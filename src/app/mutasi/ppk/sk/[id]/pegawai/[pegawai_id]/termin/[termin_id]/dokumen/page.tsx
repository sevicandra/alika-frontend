    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `/api/Mutasi/PPK/SuratKeputusan/${id}/Pegawai/${pegawai_id}/Termin/${termin_id}/Dokumen`,
          {
            method: "GET",
          },
        );
              ...
              <td className="p-4">
                {row.file && (
                  <div className="tooltip" data-tip="Detail">
                    <Link
                      href={`/mutasi/ppk/sk/${id}/pegawai/${pegawai_id}/termin/${termin_id}/dokumen/${row.id}/file`}
                    >
