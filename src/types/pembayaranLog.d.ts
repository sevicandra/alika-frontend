...
export type ReviewSanggah =
  | ReviewSanggahAdd
  | ReviewSanggahEdit
  | ReviewSanggahRemove; // Union type for different ReviewSanggah actions
...
export type PembayaranLogAttributes = PembayaranLogBase & // Intersection type to combine base attributes with specific action types
  (
    | GeneralActionAttributes
    | SanggahanDiajukanAttributes
    | SanggahanDireviewAttributes
  );
